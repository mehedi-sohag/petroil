...
export default function Header() {
  return (
    <>
      <div className="bg-[#282828] py-4 border-b-4 border-yellow-500">
        <div className="max-w-container mx-auto">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-7">
              ...
              <div className="w-0.5 h-4 bg-[#5C6A92]"></div>
              <div className="flex items-center gap-1">
                <span className="block">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex items-center gap-5">
              <a
                href="#"
                className="hover:bg-red-500 rounded-full w-[28px] h-[28px] flex items-center justify-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
      ...
      <div className="bg-[#F40404] py-7">
        <div className="max-w-container mx-auto">
          <div className="flex items-center justify-between">
            <img src={logo} alt="Logo" className="w-[192px] h-[44px]" />

            <ul className="font-poppins text-white font-semibold text-base flex items-center gap-9">
              <li>
                <a href="#">Home</a>
              </li>
              <li>
              ...
              <li>
                <a
                  href="#"
                  className="py-3.5 px-8 uppercase border-2 border-white rounded hover:bg-white hover:text-[#f40404] transition-all duration-300"
                >
                  Contact
                </a>
              </li>
